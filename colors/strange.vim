...
" hi Special ctermfg=lightgray ctermbg=none
    ...
    hi LineNr ctermbg=233  ctermfg=239 guifg=#3d464c cterm=none gui=none
    ...
    hi foldcolumn ctermbg=0 ctermfg=red guifg=#FBD485 guibg=black

    " diff
highlight DiffAdd cterm=none ctermfg=fg ctermbg=Blue gui=none guifg=fg guibg=DarkCyan
highlight DiffDelete cterm=none ctermfg=fg ctermbg=Blue gui=none guifg=fg guibg=#FF6666
highlight DiffChange cterm=none ctermfg=fg ctermbg=Blue gui=none guifg=fg guibg=SeaGreen
highlight DiffText cterm=none ctermfg=bg ctermbg=White gui=none guifg=bg guibg=Grey

highlight SignColumn  guibg=#060606
